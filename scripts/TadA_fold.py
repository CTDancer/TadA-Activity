...
def sample(args):
    ...
    folder_name = f'TadA_fold-i{args.num_recycles}_I-{args.iteration}_Mute{args.max_mute}_{str_heur}{str_conf_focus}{str_conf_w}{conf_w[0]}_Activity{args.activity_w[0]}_T{args.temperature}_seed{args.seed}'
