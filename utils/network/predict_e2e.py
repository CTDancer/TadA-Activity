...
class Predictor():
    ...
    def predict(self, a3m_fn, out_prefix, hhr_fn=None, atab_fn=None, window=150, shift=75):
        ...
        # save the results to different files respectively
        xyz_path = '/home/ubuntu/scratch/tongchen/Interact/RoseTTAFold/interact/xyz.pt'
        torch.save(torch.from_numpy(xyz), xyz_path)
        
        idx_path = '/home/ubuntu/scratch/tongchen/Interact/RoseTTAFold/interact/index.pt'
        torch.save(idx_pdb[0], idx_path)
        
        lddt_path = '/home/ubuntu/scratch/tongchen/Interact/RoseTTAFold/interact/lddt.pt'
        torch.save(lddt[0], lddt_path)
